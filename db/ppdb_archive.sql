...
INSERT INTO `ppdb_archive` (`archive_id`, `id_jalur`, `nama_lengkap`, `nisn`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `agama`, `kewarganegaraan`, `no_telp`, `alamat`, `jurusan`, `ayah_kandung`, `pekerjaan_ayah`, `ibu_kandung`, `pekerjaan_ibu`, `telp_ortu`, `alamat_ortu`, `nama_wali`, `pekerjaan_wali`, `alamat_wali`, `telp_wali`, `asal_sekolah`, `alamat_sekolah`, `tahun_lulus`, `submit_at`, `nomor_pendaftar`, `nilai`, `file`, `is_tested`) VALUES
('5edf18501bfa2', 1, 'simson duwit', '0037181176', 'kampung klamit ', '2003-07-08', 'Laki-laki', 'Protestan', 'wni', '082122160278', 'jln intimpura/kabupaten sorong', '1', 'oktovianus duwit', 'petani', 'yuliana duwit', 'petani', '082122160278', 'sayosa timur', 'elisabet mlasmene', 'petani', 'intimpura', '085244377347', 'smp negeri persiapan pasir putih', 'kampung pasir putih', 2020, 1593045984, 36109234, NULL, '', 0);
