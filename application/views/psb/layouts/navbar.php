                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li class="<?php if($this->uri->segment(1) == ""){ echo 'active'; }?>"><a href="<?= site_url()?>"><i class="fa fa-home"></i> Beranda</a></li>
                                <!--<li class="<?php if($this->uri->segment(1) == "pendaftaran"){ echo 'active'; }?>"><a href="https://drive.google.com/open?id=1G-3rmy1eHzdpf21BefGOv8ArUGsxeFBB" target="_blank">Pengumuman Kelulusan 2020 (kelas XII)</a></li>-->
                                <li class="<?php if($this->uri->segment(1) == "pendaftaran"){ echo 'active'; }?>"><a href="<?= site_url('pendaftaran')?>"><i class="fa fa-registered"></i> Pendaftaran</a></li>
                                <li class="dropdown <?php if($this->uri->segment(1) == "pencarian-data"){ echo 'active'; }?>">
                        ...
                        <?php }else{?>
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    <!--<li class="<?php if($this->uri->segment(1) == "hasil-seleksi"){ echo 'active'; }?>"><a href="<?= site_url('hasil-seleksi')?>">Hasil Seleksi</a></li>-->
