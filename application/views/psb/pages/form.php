...
<section class="blog">
    ...
    <div class="container">
        ...
        <hr>
        <div class="form-group row mt-2">
            <label for="jurusan1" class="col-sm-4 control-label">Pilih Jurusan 1 <sup style="color:#F53F37">*</sup></label>
            <div class="col-sm-8">
                <select class="form-control" name="jurusan1" style="font-size:14.5px;">
                    <option value="" hidden>--Jurusan 1--</option>
                    <option <?php if ($input['jurusan1'] == 'Akuntansi Keuangan Lembaga') {
                                echo 'selected';
                            } ?> value="Akuntansi Keuangan Lembaga">Akuntansi Keuangan Lembaga</option>
                    <option <?php if ($input['jurusan1'] == 'Otomatisasi Tata Kelola Perkantoran') {
                                echo 'selected';
