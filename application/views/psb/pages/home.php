...
<section class="blog">
    <div class="page-header">
        <div class="container">
            <div class="row">                
                <div class="col-md-12">
                    <h1>Selamat Datang di Halaman<br/><span>Penerimaan Peserta Didik Baru</span></h1>
    ...
    <div class="container">
         <div class="row"> 
            <div class="col-md-8">
                <img src="<?= base_url('assets/image/ppdb/brosur/Brosur3.jpg')?>" class="daftar-thumb" style="max-width:100%;">    
            </div>
            <!--<div class="col-md-12">-->
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tr>
                                <td>
                                <div class="p-b-20 alert bgm-orange f-wht text-center"><p class="muted"><strong><i class="fa fa-exclamation-triangle"></i> Harap dibaca </strong></p></div><br/>
                                <small> 
                                    <li>
