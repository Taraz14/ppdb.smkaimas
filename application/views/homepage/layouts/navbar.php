                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="<?php if ($this->uri->segment(1) == "psb") {
                                                echo 'active';
                                            } ?>"><a href="<?= site_url('psb') ?>">PPDB (2020)</a></li>
                                <li class="<?php if ($this->uri->segment(1) == "berita" || $this->uri->segment(2) == "berita") {
                                                echo 'active';
                                            } ?>"><a href="<?= site_url('berita') ?>">Berita & Artikel</a></li>
                                <li class="<?php if ($this->uri->segment(1) == "blog") {
                                                echo 'active';
                                            } ?>"><a href="<?= site_url('blog') ?>">Galeri</a></li>
                                <!-- <li class="<?php if ($this->uri->segment(1) == "blog") {
                                                    echo 'active';
