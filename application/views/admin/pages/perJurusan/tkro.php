        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body pad">
                    <table class="table table-bordered table-hover display nowrap" style="width:100%" id="tkro_admin">
                        <thead>
                            <tr>
                                <th>No. Pendaftar</th>
                                <th>Nama Lengkap</th>
...
<script>
  ...
  $(function(){
        //Datatable : AKL -> Admin
        akl_admin = $('#tkro_admin').DataTable({
        "processing"  : true,
        "serverSide"  : true,
        "scrollX"       : true,
        "scrollY"       : "200px",
        ...
        "order"       : [],
        "ajax"        : {
          url         : '<?= site_url('admin/perJurusan/Tkro/getJur')?>',
        },
        "columnDefs" : [
            {
