        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body pad">
                    <table class="table table-bordered table-hover display nowrap" style="width:100%" id="akl_admin">
                        <thead>
                            <tr>
                                <th>No. Pendaftar</th>
                                <th>Nama Lengkap</th>
...
<script>
    ...
    $(function() {
        ...
        akl_admin = $('#akl_admin').DataTable({
            ...
            "order": [],
            "ajax": {
                url: '<?= site_url('admin/perJurusan/Akl/getJur') ?>',
            },
            "columnDefs": [{
