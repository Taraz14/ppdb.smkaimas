...
class Tbsm extends MY_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('perjurusan/tbsm_m');
    ...
    public function index()
    {
        $this->load->view('layouts/wrapper', [
            'content' => 'admin/pages/perJurusan/tbsm',
            'header'=> 'Teknik dan Bisnis Sepeda Motor',
        ]);
        
    }

    public function getJur(){
        $data = $this->tbsm_m->dataJur();
        $jur = [];
        ...
        $output['recordsTotal'] = $this->tbsm_m->countAll();
        $output['recordsFiltered'] = $this->tbsm_m->filtered();
        $output['data'] = $jur;
