...
class Tkro extends MY_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('perjurusan/tkro_m');
    ...
    public function index()
    {
        $this->load->view('layouts/wrapper', [
            'content' => 'admin/pages/perJurusan/tkro',
            'header'=> 'Teknik Kendaraan Ringan Otomotif',
        ]);
        
    }

    public function getJur(){
        $data = $this->tkro_m->dataJur();
        $jur = [];
        ...
        $output['recordsTotal'] = $this->tkro_m->countAll();
        $output['recordsFiltered'] = $this->tkro_m->filtered();
        $output['data'] = $jur;
