...
class Titl extends MY_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('perjurusan/titl_m');
    ...
    public function index()
    {
        $this->load->view('layouts/wrapper', [
            'content' => 'admin/pages/perJurusan/titl',
            'header'=> 'Teknik Instalasi Tenaga Listrik',
        ]);
        
    }

    public function getJur(){
        $data = $this->titl_m->dataJur();
        $jur = [];
        ...
        $output['recordsTotal'] = $this->titl_m->countAll();
        $output['recordsFiltered'] = $this->titl_m->filtered();
        $output['data'] = $jur;
