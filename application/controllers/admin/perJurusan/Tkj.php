...
class Tkj extends MY_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('perjurusan/tkj_m');
    ...
    public function index()
    {
        $this->load->view('layouts/wrapper', [
            'content' => 'admin/pages/perJurusan/tkj',
            'header'=> 'Teknik Komputer dan Jaringan',
        ]);
        
    }

    public function getJur(){
        $data = $this->tkj_m->dataJur();
        $jur = [];
        ...
        $output['recordsTotal'] = $this->tkj_m->countAll();
        $output['recordsFiltered'] = $this->tkj_m->filtered();
        $output['data'] = $jur;
