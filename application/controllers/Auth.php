...
class Auth extends MY_Controller
{
	...
	{
		if ($this->require_role('admin,guru,siswa')) {
			// echo $this->auth_role;
			redirect($this->auth_role . '/dashboard', 'refresh');
		}
	}
	...
	public function create_user()
	{
		...
		$user_data = [
			'username'   => 'novel',
			'passwd'     => 'Novel1994',
			'email'      => 'novel.dwijaksana@gmail.com',
	...
	public function ajax_attempt_login()
	{
		if ($this->input->is_ajax_request()) {
			...
			// Login attempt not successful
				...
				$on_hold = ($this->authentication->on_hold === TRUE or
